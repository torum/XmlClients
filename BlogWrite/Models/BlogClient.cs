...
namespace BlogWrite
{
    ...
    public class BlogClient
    {
        ...
        public async Task<NodeServies> GetAccount(string accountName)
        {
            NodeServies account = new NodeServies(accountName, _userName, _userPassword, _endpoint);
        ...
        public async Task<NodeCollections> GetBlogs()
        {
        ...
        public async Task<List<EntryItem>> GetEntries(Uri entriesUrl)
        {
        ...
        public async Task<EntryFull> GetFullEntry(Uri entryUri)
        {
        ...
        public async Task<bool> UpdateEntry(EntryFull entry)
        {
            // TODO: For now
        ...
        public async Task<bool> PostEntry(EntryFull entry)
        {
        ...
        public async Task<bool> DeleteEntry(Uri editUri)
        {
            var request = new HttpRequestMessage
            {
